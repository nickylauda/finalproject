...
//               end: Alignment.bottomCenter,
//               // colors: [
//               //   Color(0xFF02AAB0), // Deep Green
//               //   Color(0xFF00CDAC), // Light Lime
//               // ],
//               // begin: Alignment.topCenter,
//               // end: Alignment.bottomCenter,
//             ),
...
//                     backgroundImage: AssetImage(
//                         'assets/homes/profile.jpg'), // Add your image path
//                   ),
//                   SizedBox(width: 12),
//                   Text(
//                     'Bucket',
...
// }
import 'package:flutter/material.dart';
import 'package:my_bucket/Homepage/home_searchfield.dart';
...
class MyAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  // Avatar Image
                  CircleAvatar(
                    radius: 21, // Adjust the size of the avatar
                    backgroundImage: AssetImage(
                        'assets/homes/profile.jpg'), // Add your image path
                  ),
                  SizedBox(width: 12),
      ...
      // Add action icons to the app bar
      actions: [
        IconButton(
          icon: const Icon(Icons.notifications, size: 22, color: Colors.white),
          onPressed: () {
